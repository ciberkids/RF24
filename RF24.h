...
s   *
  ...
  */
   ...
   */
  bool isValid() {
    //Serial.println(F("Radio valid??? cepin:"));
    //Serial.println(ce_pin != 0xff);
    //Serial.println(F("Radio valid??? csnpin:"));
    //Serial.println(csn_pin != 0xff);
    //Serial.println(F("logic and"));
    //Serial.println(ce_pin != 0xff && csn_pin != 0xff);
    bool ret = (ce_pin != 0xff && csn_pin != 0xff);
